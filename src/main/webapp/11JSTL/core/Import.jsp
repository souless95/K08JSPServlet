...
-->
	...
	달라지면 경로도 수정되야 하므로 이를 최소화할 수 있도록
	개발하는것이 좋다.
	특히 JSTL에서 url 지정할때 컨텍스트 루트 경로는 명시하지 않아도 되므로
	일반적인 방식보다 작성에 유리한점이 있다.
	-->
	<div>
		<h4>이미지 삽입하기</h4>
		<h5>상대경로 지정</h5>
		<img alt="" src="../../images/Error.jpg" width="150" height="80" />
		<h5>절대경로 지정(경로명 하드코딩)</h5>
		<img alt="" src="/K08JSPServlet/images/Error.jpg" width="150" height="80" />
		<h5>절대경로 지정(request 내장객체 사용)</h5><!-- >> 경로 수정없이 사용할 수 있는 좋은 방법 -->
		<img alt="" src="<%= request.getContextPath() %>/images/Error.jpg" width="150" height="80" />
	</div>
